...
// let characterReferenceData = '';
// let characterToken = '';
// let tagNameToken = '';
// let attributeNameState = '';
// let attributeValueState = '';
//
// class Attribute {}
//
// class StartTagToken {}
...
function emitToken(token) {
  ...
  if(token.type == 'startTag') {
    ...
    currentTextNode = null
      ...
      currentTextNode.connect += token.content;
  }
}
...
function afterAttributeQuotedValue(c) {
  if(c.match(/^[\t\n\f ]$/)){
    ...
    console.log('Reconsume in the before attribute name state', c);
    // Anything else
...
//
//   constructor() {
//     this.characterReferenceData = '';
//     this.characterToken = '';
//     this.tagNameToken = '';
//     this.currentToken = {};
//     this.currentAttribute = {};
//     this.attributeNameState = '';
//     this.attributeValueState = '';
...
//               content: ''
//             }
//             top.children.pushcurrentTextNode()
//           }
//           currentTextNode.connect += token.content;
//         }
//       }
...
//     }
//   }
//   //问题： 老师 在 5-attribute 的parser中，对应的逻辑和 whatwcg不一致？
//   function afterAttributeQuotedValue(c) {
//     if(c.match(/^[\t\n\f ]$/)){
//       // U+0009 CHARACTER TABULATION (tab)
//       // U+000A LINE FEED (LF)
...
//       // Switch to the before attribute name state.
//       currentToken[currentAttribute.name] = currentAttribute.value;
//       console.log('unquotedAttributeValue 1', currentToken);
//       return beforeAttributeName(c);
//     }else if (c === AMPERSAND) {
//       // U+0026 AMPERSAND (&)
//       // Set the return state to the attribute value (unquoted) state.
//       // Switch to the character reference state.
//       console.log('unquotedAttributeValue 2', currentToken);
//       return characterReferenceInData;
//     }else if (c === GREATER_THAN) {
//       // U+003E GREATER-THAN SIGN (>)
//       // Switch to the data state.
//       // Emit the current tag token.
//       console.log('unquotedAttributeValue 3', currentToken);
//       emitToken(currentToken);
//       return data;
//     }else if (c === NULL) {
//       // U+0000 NULL
